(function () {
    ...
    function getDashboard() { return document.querySelector(".dashboard"); }
    function getDashboardColumns() { return getDashboard().querySelectorAll(tuxDashboardColumn); }
    ...
    function getWidgetsOnDashboard() { return getDashboard().querySelectorAll(tuxWidgetClass); }
