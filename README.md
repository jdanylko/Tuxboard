...
**UPDATE:** Version [10.0.0](https://github.com/jdanylko/Tuxboard/pull/48) is now available on <a href="https://www.nuget.org/packages/Tuxboard.Core/" title="Go to Tuxboard.Core on NuGet.org">NuGet</a>.
