...
**UPDATE:** Version [1.9.6](https://github.com/jdanylko/Tuxboard/pull/44) is now available on <a href="https://www.nuget.org/packages/Tuxboard.Core/" title="Go to Tuxboard.Core on NuGet.org">NuGet</a>.
