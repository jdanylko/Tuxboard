...
exports.isLayoutListItem = exports.createFromHtml = exports.isBefore = exports.getWidgetIndex = exports.getColumnIndexByDragInfo = exports.getColumnByPlacement = exports.getWidgetSnapshot = exports.getClosestByClass = exports.isWidget = exports.clearNodes = exports.enableElement = exports.disableElement = exports.noPeriod = exports.getPlacementId = exports.getDomWidget = exports.getDataId = exports.collapsedToggleSelector = exports.isStaticAttribute = exports.dataId = void 0;
...
function getWidgetSnapshot(dragInfo) {
    ...
    return widgetList.map((elem) => {
        ...
        return new PlacementItem_1.PlacementItem(placementId, widgetIndex, rowTemplate.getAttribute(exports.dataId), columnIndex, isStatic);
    });
}
